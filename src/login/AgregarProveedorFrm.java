...
public class AgregarProveedorFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setBackground(new java.awt.Color(98, 57, 179));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Persona Moral", "Persona física" }));
        ...
        jLabel8.setForeground(new java.awt.Color(98, 57, 179));
        jLabel8.setText("Teléfono:");

        jTextField4.setBackground(new java.awt.Color(98, 57, 179));
        jTextField4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        jLabel9.setBackground(new java.awt.Color(98, 57, 179));
        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(98, 57, 179));
        jLabel9.setText("Correo electrónico:");

        jTextField5.setBackground(new java.awt.Color(98, 57, 179));
        jTextField5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        jLabel10.setBackground(new java.awt.Color(98, 57, 179));
        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(98, 57, 179));
        jLabel10.setText("Tipo de producto:");

        jRadioButton1.setForeground(new java.awt.Color(98, 57, 179));
        ...
        jRadioButton2.setForeground(new java.awt.Color(98, 57, 179));
        jRadioButton2.setText("Laptops");

        jRadioButton3.setForeground(new java.awt.Color(98, 57, 179));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarProveedorFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarProveedorFrm().setVisible(true);
            }
        });
    }
