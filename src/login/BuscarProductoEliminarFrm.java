 ...
 * @author crist
 */
public class BuscarProductoEliminarFrm extends javax.swing.JFrame {

    /**
     * Creates new form BuscadorStockFrm
     */
    public BuscarProductoEliminarFrm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarProductoEliminarFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarProductoEliminarFrm().setVisible(true);
            }
        });
    }
