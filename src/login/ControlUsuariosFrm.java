 ...
 * @author crist
 */
public class ControlUsuariosFrm extends javax.swing.JFrame {

    /**
     * Creates new form StockGeneroFrm
     */
    public ControlUsuariosFrm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlUsuariosFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControlUsuariosFrm().setVisible(true);
            }
        });
    }
